...
const ITEM_TEMPLATES = {
  ...
  shortbow: { name:'Short Bow', glyph:'(', color:'#aa7733', type:'weapon', slot:'ranged', dmg:[1,6,0], ranged:true, ammo:'arrows', val:30, category:'ranged', speed:'normal' },
  longbow: { name:'Long Bow', glyph:'(', color:'#885522', type:'weapon', slot:'ranged', dmg:[1,8,2], ranged:true, ammo:'arrows', twoHand:true, val:60, category:'ranged', speed:'slow' },
  crossbow: { name:'Crossbow', glyph:'(', color:'#775533', type:'weapon', slot:'ranged', dmg:[2,6,0], ranged:true, ammo:'bolts', twoHand:true, val:50, category:'ranged', speed:'slow' },
  sling: { name:'Sling', glyph:'(', color:'#997755', type:'weapon', slot:'ranged', dmg:[1,4,0], ranged:true, ammo:'stones', val:5, category:'ranged', speed:'fast' },
